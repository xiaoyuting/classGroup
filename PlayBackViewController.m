...
@interface PlayBackViewController ()<VodPlayDelegate,VodDownLoadDelegate,GSVodDocViewDelegate>
...
//            self.vodplayer = ((AppDelegate*)[UIApplication sharedApplication].delegate).vodplayer;
            ...
            self.vodplayer.mVideoView.backgroundColor = [UIColor redColor];
