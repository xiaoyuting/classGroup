...
@property (strong ,nonatomic)NSArray *DDXRightAnswer;//多选的标准答案
...
@property (strong ,nonatomic)NSArray *imageIDArray;//图片数组

@property (assign ,nonatomic)NSInteger timeOut;//时间用完交卷

@property (strong ,nonatomic)NSMutableArray *ZGUpImageArray;//上传的图片的数组
@property (strong ,nonatomic)NSMutableArray *ZGUpImageIDArray;//上传图片ID的数组
