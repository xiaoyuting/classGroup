...
@implementation SYGClassTableViewCell
...
-(void)initLayuot{
    ...
    _OrderLabel = [[UILabel alloc] initWithFrame:CGRectMake(MainScreenWidth - 100, CGRectGetMaxY(_contentLabel.frame) + 2, 80, 15)];
