...
-(void)initLayuot{
    ...
    _NameLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 10, MainScreenWidth - 110, 20)];
    _NameLabel.font = [UIFont systemFontOfSize:16];
    [self addSubview:_NameLabel];
    
    _TextLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 35, MainScreenWidth - 110, 15)];
