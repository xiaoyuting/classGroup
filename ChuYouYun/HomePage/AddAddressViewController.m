...
//    
 ...
 NSDictionary *parameter=@{@"oauth_token": key,@"oauth_token_secret": passWord ,@"province": _province,@"city": _city,@"area": _area,@"address": _detilAdress,@"name": _name,@"phone": _phone,@"is_default": _is_default};


    [manager getpublicPort:parameter mod:@"Address" act:@"addAdress" success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
//    [SXButton setBackgroundImage:[UIImage imageNamed:@"资讯分类@2x"] forState:UIControlStateNormal];
    ...
    [SXButton setTitleColor:[UIColor colorWithRed:32.0/255 green:105.0/255 blue:207.0/255 alpha:1] forState:UIControlStateNormal];
