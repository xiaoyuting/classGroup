...
@interface allClassVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (id)initWithMemberIds:(NSString *)mumberIds
{
    if (self=[super init]) {
        _cateory_id = mumberIds;
    }
    return self;
}
...
- (void)viewDidLoad {
    ...
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, MainScreenWidth, MainScreenHeight-150 + 20 + 5) style:UITableViewStyleGrouped];
...
-(void)requestData:(NSInteger)num
{
    ...
    NSArray *ALLArray = [ALLClassTool classWithDic:dic];
...
//            [ALLClassTool saveClasses:responseObject[@"data"]];
            ...
            if(IsNilOrNull(array))
            {
                ...
                UILabel *hintLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, MainScreenWidth, 50)];
