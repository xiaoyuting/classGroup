...
- (void)netWorkAboutUs {
    ...
    [manager BigWinCar_showAbout:dic success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
- (void)addWebView {
    ...
    NSURL *url = nil;
    NSString *str1 = @"app=api&mod=Public&act=showAbout";
    NSString *urlStr = [NSString stringWithFormat:@"%@%@",basidUrl,str1];
