...
@interface blumPlayQuestionVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation blumPlayQuestionVC
...
- (void)viewDidLoad {
    ...
    _lable = [[UILabel alloc]initWithFrame:CGRectMake(0, 100,MainScreenWidth, 14)];
...
//    [self.navigationController pushViewController:qvc animated:YES];
    blumMakeQuestionsVC * mvc = [[blumMakeQuestionsVC alloc]init];
    mvc.blumID = _blumID;
