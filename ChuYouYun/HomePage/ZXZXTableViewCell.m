...
-(void)initLayuot{
    ...
    //阅读
    _readLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_imageButton.frame) + 13, 13 + 16 + 2, 100, 15)];
    ...
    //时间
    _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(MainScreenWidth - 140, 31, 130, 15)];
    ...
    //具体
    _JTLabel = [[UILabel alloc] initWithFrame:CGRectMake(MainScreenWidth / 5 * 2 + 13, 40 + 3, MainScreenWidth - MainScreenWidth / 5 * 2 - 13 - 10, 62)];
    _JTLabel.font = [UIFont systemFontOfSize:13];
    _JTLabel.numberOfLines = 3;
