...
- (void)addWZView {
    ...
    //添加按钮
    NSArray *titleArray = @[@"全部",@"待支付",@"已取消",@"已完成",@"申请退款",@"已退款"];
...
- (void)addControllerSrcollView {
    ...
    paidVc.view.frame = CGRectMake(MainScreenWidth * 3, -98, MainScreenWidth, MainScreenHeight);
    ...
    noRefundVc.view.frame = CGRectMake(MainScreenWidth * 4, -98, MainScreenWidth, MainScreenHeight);
    ...
    refundVc.view.frame = CGRectMake(MainScreenWidth * 5, -98, MainScreenWidth, MainScreenHeight);
