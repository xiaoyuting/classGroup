//
//  ZhiboPayViewController.m
//  dafengche
//
//  Created by 赛新科技 on 2017/5/11.
...
@interface ZhiboPayViewController ()<UIWebViewDelegate> {
    BOOL isArgree;
}
...
@implementation ZhiboPayViewController
...
- (void)addInfoView {
    ...
    NSArray *titleArray = @[@"课程：",@"价格：",@"使用优惠券："];
...
- (void)chooseButtonClick {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        //改变位置 动画
        _buyView.frame = CGRectMake(MainScreenWidth / 4 ,64 ,MainScreenWidth / 2, 85);
        _buyView.center = self.view.center;
...
- (void)classBuyNetInfoAlipay {
    ...
    [manager BigWinCar_buyZhiBo:dic success:^(AFHTTPRequestOperation *operation, id responseObject) {
