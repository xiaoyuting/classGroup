...
@interface GreatViewController ()<UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
...
- (void)netWork {
    ...
    if (_nameField.text.length > 0) {
        ...
        [MBProgressHUD showError:@"请完善资料" toView:self.view];
    }
