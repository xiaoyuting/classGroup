...
#import "CC_PlayBackViewController.h"
...
#import "CC_PlayViewController.h"

#import "CC _header.h"

@interface CC_PlayBackViewController ()<UITextFieldDelegate,RequestDataPlayBackDelegate>
...
@implementation CC_PlayBackViewController
    ...
    _navigationView = [[NavigationView alloc] initWithTitle:@"观看回放" pushBlock:^(NSInteger index) {
        ...
        switch (index) {
            case 1:
                ...
                break;
            case 2:
                viewController = [[CC_PlayViewController alloc] init];
                break;
            case 3:
                viewController = [[CC_PlayBackViewController alloc] init];
                break;
            default:
                break;
        }
...
-(void)viewWillAppear:(BOOL)animated {
    ...
    //    self.textFieldUserId.text = @"8A6BE16C0FDC1C08";
    //    self.textFieldRoomId.text = @"A4E58AC0F4515A9D9C33DC5901307461";
    //    self.textFieldLiveId.text = @"A96A63EE4E520EED";
