...
@interface GLPayView ()<UIScrollViewDelegate,UIWebViewDelegate,UITableViewDelegate,UITableViewDataSource>{
...
-(instancetype)initWithFrame:(CGRect)frame Buydic:(NSDictionary *)buydic withBuyMod:(id)buymod withBuyAct:(NSString *)buyact withYHJdic:(NSDictionary *)YHJdic withYHJmod:(NSString *)YHJmod withYHJAct:(NSString *)YHJact withPrice:(NSString *)price{
