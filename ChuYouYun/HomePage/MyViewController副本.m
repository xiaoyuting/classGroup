...
- (void)addMYView {
    ...
    //添加整个View
    UIView *SYGView = [[UIView alloc] initWithFrame:CGRectMake(0, 270, MainScreenWidth, MainScreenHeight - 60 + 100)];
...
//    }
    ...
    NSArray *SYGArray = @[@"我的直播",@"我的课程",@"我的笔记",@"我的收藏",@"我的订单",@"我的问答",@"我的下载",@"观看记录",@"我的优惠券",@"我的机构",@"我的文库"];
    for (int i = 0 ; i < SYGArray.count ; i ++) {

        NSArray *TBArray = @[@"iconfont-zhuanji-copy@2x",@"iconfont-baomingkechengdisc@2x",@"iconfont-biji@2x",@"iconfont-shoucang@2x",@"我的购物车@2x",@"iconfont-navwenda@2x",@"iconfont-navwenda@2x",@"iconfont-navwenda@2x",@"iconfont-navwenda@2x",@"iconfont-navwenda@2x",@"iconfont-navwenda@2x"];
