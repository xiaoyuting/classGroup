...
@interface blumQuestionVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)viewDidLoad {
    ...
    _lable = [[UILabel alloc]initWithFrame:CGRectMake(0, 50*MainScreenHeight/667,MainScreenWidth, 14)];
...
- (void)questionBtn
{
    MakeBiumQuestion *makeBlumVC = [[MakeBiumQuestion alloc] init];
    makeBlumVC.courseId = self.blum_id;
    [self.navigationController pushViewController:makeBlumVC animated:YES];
}
