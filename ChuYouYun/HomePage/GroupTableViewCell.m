...
-(void)initLayuot{
    ...
    //头像
    _headImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 15, 120, 80)];
//    _headImageView.layer.masksToBounds = YES;
//    _headImageView.layer.cornerRadius = 25;
    [self addSubview:_headImageView];
    
    //标题
    _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(150, 15,MainScreenWidth - 80, 20)];
    [self addSubview:_nameLabel];
    
    //内容
    _contentlabel = [[UILabel alloc] initWithFrame:CGRectMake(150, 40 , MainScreenWidth - 160, 35)];
    ...
    //贴子和成员
    _mixLabel = [[UILabel alloc] initWithFrame:CGRectMake(150, 80,(MainScreenWidth - 150 - 2 * SpaceBaside) / 2, 15)];
    [self addSubview:_mixLabel];
    _mixLabel.textColor = [UIColor grayColor];
    _mixLabel.font = Font(13);
    
    _member = [[UILabel alloc] initWithFrame:CGRectMake(150 + (MainScreenWidth - 150 - 2 * SpaceBaside) / 2 , 80,(MainScreenWidth - 150 - 2 * SpaceBaside) / 2, 15)];
    [self addSubview:_member];
    _member.textColor = [UIColor grayColor];
    _member.font = Font(13);
